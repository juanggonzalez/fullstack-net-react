    ...
    public partial class AddEcommerceEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Leading electronics manufacturer", "TechPro" },
                    { 2, "Publisher of classic literature", "Bookworm Inc." },
                    { 3, "Trendy clothing brand", "FashionWear" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Description", "Name" },
                values: new object[] { 4, "Appliances and decor", "Home & Kitchen" });
